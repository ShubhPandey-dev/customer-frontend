...
function Cart() {
  ...
  async function updateQuantity(item, nextQuantity) {
    ...
    try {
      await axios.patch(
        `https://ecom-common-backend.onrender.com/customer/cart/item/${item.cart_item_id}`,
  ...
  async function removeItem(item) {
    ...
    try {
      await axios.delete(`https://ecom-common-backend.onrender.com/customer/cart/item/${item.cart_item_id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
